...
CCTK_HOST CCTK_DEVICE inline void uvel(CCTK_REAL alp, CCTK_REAL betax,
                                       CCTK_REAL betay, CCTK_REAL betaz,
                                       CCTK_REAL w_lorentz, CCTK_REAL velx,
                                       CCTK_REAL vely, CCTK_REAL velz,
                                       CCTK_REAL u[4]) {
