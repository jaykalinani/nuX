...
normal(CCTK_REAL const alp, CCTK_REAL const betax, CCTK_REAL const betay,
       CCTK_REAL const betaz, CCTK_REAL n[4]) {
...
//! Construct a spatial metric matrix γ_ij in row-major (xx,xy,xz, yx,yy,yz,
//! zx,zy,zz)
CCTK_HOST CCTK_DEVICE inline void
space(CCTK_REAL const gxx, CCTK_REAL const gxy, CCTK_REAL const gxz,
...
spatial_det(CCTK_REAL const gxx, CCTK_REAL const gxy, CCTK_REAL const gxz,
            CCTK_REAL const gyy, CCTK_REAL const gyz, CCTK_REAL const gzz) {
  // Standard symmetric 3x3 determinant
  return gxx * gyy * gzz + 2.0 * gxy * gxz * gyz - gxx * gyz * gyz -
         gyy * gxz * gxz - gzz * gxy * gxy;
}

//! det(γ_ij) from 3x3 array (row-major)
CCTK_HOST CCTK_DEVICE inline CCTK_REAL spatial_det(CCTK_REAL const gamma[9]) {
...
CCTK_HOST CCTK_DEVICE inline void
spatial_inv(CCTK_REAL const det, CCTK_REAL const gxx, CCTK_REAL const gxy,
            CCTK_REAL const gxz, CCTK_REAL const gyy, CCTK_REAL const gyz,
            CCTK_REAL const gzz, CCTK_REAL *uxx, CCTK_REAL *uxy, CCTK_REAL *uxz,
...
CCTK_HOST CCTK_DEVICE inline void spatial_inv(CCTK_REAL const det,
                                              CCTK_REAL const gamma[9],
                                              CCTK_REAL ugamma[9]) {
  CCTK_REAL uxx, uxy, uxz, uyy, uyz, uzz;
  spatial_inv(det, gamma[0], gamma[1], gamma[2], gamma[4], gamma[5], gamma[8],
...
CCTK_HOST CCTK_DEVICE inline void
spacetime(CCTK_REAL const alp, CCTK_REAL const betax, CCTK_REAL const betay,
          CCTK_REAL const betaz, CCTK_REAL const gxx, CCTK_REAL const gxy,
          CCTK_REAL const gxz, CCTK_REAL const gyy, CCTK_REAL const gyz,
          CCTK_REAL const gzz, CCTK_REAL g[16]) {
  // Build γ_ij
  CCTK_REAL gamma[9];
...
CCTK_HOST CCTK_DEVICE inline void
spacetime_upper(CCTK_REAL const alp, CCTK_REAL const betax,
  ...
  CCTK_REAL uxx, uxy, uxz, uyy, uyz, uzz;
  spatial_inv(det, gxx, gxy, gxz, gyy, gyz, gzz, &uxx, &uxy, &uxz, &uyy, &uyz,
              &uzz);
  ...
  u[5] = uxx - betax * betax * inv_a2;
  u[6] = uxy - betax * betay * inv_a2;
  u[7] = uxz - betax * betaz * inv_a2;
  u[9] = uxy - betay * betax * inv_a2;
  u[10] = uyy - betay * betay * inv_a2;
  u[11] = uyz - betay * betaz * inv_a2;
  u[13] = uxz - betaz * betax * inv_a2;
  u[14] = uyz - betaz * betay * inv_a2;
  u[15] = uzz - betaz * betaz * inv_a2;
}
