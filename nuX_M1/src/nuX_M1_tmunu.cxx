...
extern "C" void nuX_M1_AddToTmunu(CCTK_ARGUMENTS) {
  ...
  grid.loop_all_device<1, 1, 1>(
      ...
      [=] CCTK_DEVICE(const PointDesc& p) {
        ...
        get_metric(ijk, alp, betax, betay, betaz, gxx, gxy, gxz,
                   gyy, gyz, gzz, g_dd);
        ...
        get_fluid_velocity(ijk, alp, betax, betay, betaz,
                           fidu_w_lorentz, fidu_velx, fidu_vely, fidu_velz, u_u);
        ...
        for (int ig = 0; ig < nspecies * ngroups; ++ig) {
          ...
          calc_closure(cctkGH, p.i, p.j, p.k, ig,
                       closure_fun, gsl_solver,
                       g_dd, g_uu, n_d,
                       W, u_u, v_d, proj_ud,
                       rE[i4D], F_d,
                       mychi, P_dd);
