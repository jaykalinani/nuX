...
const CCTK_REAL nu_n_prefactor =
    4.0 / 3.0 * pi /
    (hc_mevfm * hc_mevfm * hc_mevfm); // 4/3 *pi/(hc)**3 [1/MeV^3/fm^3]
const CCTK_REAL nu_e_prefactor =
    4.0 * pi /
    (hc_mevfm * hc_mevfm * hc_mevfm); // 4*pi/(hc)**3    [1/MeV^3 fm^3]
...
eta_e_gradient(CCTK_REAL rho, CCTK_REAL T, CCTK_REAL *Y, CCTK_REAL eta,
               CCTK_REAL &deta_dT, CCTK_REAL &deta_dYe, CCTK_REAL &de_dT,
               CCTK_REAL &de_dYe, const EOSType *tabeos) {
  int ierr = 1;
...
/// Master Function: Calculate hot (neutrino trapped) beta equilibrium T_eq and
...
BetaEquilibriumTrapped(CCTK_REAL rho, CCTK_REAL n, CCTK_REAL e, CCTK_REAL Yl,
  ...
  CCTK_REAL vec_guess[n_at][2] = {
      ...
      {0.90e0, 0.90e0}, {0.90e0, 0.75e0}, {0.75e0, 1.25e0}, {0.75e0, 1.10e0},
      {0.75e0, 1.00e0}, {0.75e0, 0.90e0}, {0.75e0, 0.75e0}, {0.50e0, 1.25e0},
      {0.50e0, 1.10e0}, {0.50e0, 1.00e0}, {0.50e0, 0.90e0}, {0.50e0, 0.75e0},
  };
