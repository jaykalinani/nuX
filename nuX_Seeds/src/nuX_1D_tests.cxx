...
extern "C" void nuX_Tests1D(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_nuX_Tests1D;
  DECLARE_CCTK_PARAMETERS;

  // For all the tests, the initial data EOS is ideal gas
  // Get local eos object

  if (CCTK_EQUALS(nuX_test_case, "diff_step")) {
      if (verbose) CCTK_INFO("nuX_M1_SetupTest_diff_step");
